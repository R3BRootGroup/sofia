...
void R3BSofMwpc2::SetSpecialPhysicsCuts() { LOG(INFO) << "-I- R3BSofMwpc2: Adding customized Physics cut ... "; }
...
void R3BSofMwpc2::Register()
{
    FairRootManager::Instance()->Register("SofMwpc2Point", GetName(), fSofMWPCCollection, kTRUE);
}
// ----------------------------------------------------------------------------
