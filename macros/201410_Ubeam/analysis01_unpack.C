...
#if COMREF_MAPPED
    source->AddReader(
        new R3BSofComRefReader((EXT_STR_h101_SOFCOMREF_t*)&ucesb_struct.comref, offsetof(EXT_STR_h101, comref)));
#endif
#if SCI_MAPPED
...
#endif
#if TRIM_MAPPED
    source->AddReader(new R3BSofTrimMadcVftxReader((EXT_STR_h101_SOFTRIM_MADCVFTX_t*)&ucesb_struct.trim,
                                                   offsetof(EXT_STR_h101, trim)));
#endif
#if TWIM_MAPPED
    source->AddReader(new R3BSofTwimMadcVftxReader((EXT_STR_h101_SOFTWIM_MADCVFTX_t*)&ucesb_struct.twim,
