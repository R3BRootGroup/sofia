...
void SofSciMapped(Int_t First=3580)
{
  ...
  TString outputFileName = "../SofMacrosOutput/201607_Cbeam/SofSciMapped_run"+runNumber+".root";
  TString ntuple_options = "UNPACK:EVENTNO,UNPACK:TRIGGER,RAW";
  TString ucesb_dir = getenv("UCESB_DIR");
  TString ucesb_path = ucesb_dir + "/../upexps/sofia2016jul/sofia2016jul"
