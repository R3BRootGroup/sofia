...
//  pMedFill->SetName("Fill_Vacuum");
 ...
 //  fNbOfSensitiveVol+=1;
  ...
  // pWorld->AddNode(base_log7, 0, pGlobal2);
   ...
   // Cuadro de fibras perpendiculares pieza 4
  ...
  // pWorld->AddNode(basesub_log17, 0, pGlobal5);
   ...
   // Volume: 
   TGeoVolume*
   Detector_log2 = new TGeoVolume("MWPC22",Detector2, pMedAr);
 ...
 //  fNbOfSensitiveVol+=1;
  ...
  // pWorld->AddNode(base_log21, 0, pGlobal7);
   ...
   TGeoVolume*
   basesub_log23 = new TGeoVolume("basesub_log23",basesub_23, pMedAl);
   ...
   // Añado targetas PCB a los laterales


   // TRANSFORMATION MATRICES
   // Combi transformation: 
   dx = 4.5*39.0/2.0+7.0/2.0;
   dy = 0.000;
   dz = -1.200;
  ...
  // pWorld->AddNode(basesub_log26, 0, pGlobal10);
   ...
   TGeoVolume*
   basesub_log27 = new TGeoVolume("basesub_log27",basesub_27, pMedAl);
