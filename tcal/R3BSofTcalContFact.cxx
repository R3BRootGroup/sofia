...
void R3BSofTcalContFact::setAllContainers()
{
  ...
  // --- ---------------------------------- --- //
  FairContainer* p1= new FairContainer("SofSciTcalPar",
                                       "Sof Tcal Parameters",
                                       "SofTcalParContext");
  ...
  // --- ----------------------- --- //
  FairContainer* p2= new FairContainer("SofToFWTcalPar",
                                       "Sof Tcal Parameters",
                                       "SofTcalParContext");
  ...
  // --- ---------------------------------------------- --- //
  FairContainer* p3= new FairContainer("SofTrimTcalPar",
                                       "Sof Tcal Parameters",
                                       "SofTcalParContext");
  ...
  // --- -------------------------------------------- --- //
  FairContainer* p4= new FairContainer("SofTwimTcalPar",
                                       "Sof Tcal Parameters",
                                       "SofTcalParContext");
