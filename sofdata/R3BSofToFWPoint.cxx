...
// -----   Default constructor   -------------------------------------------
R3BSofToFWPoint::R3BSofToFWPoint() : FairMCPoint() {
...
R3BSofToFWPoint::R3BSofToFWPoint(Int_t trackID, Int_t detID, Int_t detCopyID,
...
void R3BSofToFWPoint::Print(const Option_t* opt) const {
  cout << "-I- R3BSofToFWPoint: STS Point for track " << fTrackID 
