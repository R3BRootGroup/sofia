...
class R3BSofSciCalData : public TObject
{
  public:
    ...
    void SetRawTimeNs(UShort_t det, UShort_t pmt, Double_t tns)
    {
        fRawTimeNs->AddAt(tns, (det - 1) * NUM_SOFSCI_PMT + pmt - 1);
    }
    ...
    Double_t GetRawTimeNs(UShort_t det, UShort_t pmt)
    {
        return (Double_t)fRawTimeNs->At((det - 1) * NUM_SOFSCI_PMT + pmt - 1);
    }
