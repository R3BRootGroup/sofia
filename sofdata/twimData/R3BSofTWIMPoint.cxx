...
// -----   Default constructor   -------------------------------------------
R3BSofTWIMPoint::R3BSofTWIMPoint() : FairMCPoint() {
...
R3BSofTWIMPoint::R3BSofTWIMPoint(Int_t trackID, Int_t detID, Int_t detCopyID,
                         Double_t Z, Double_t A,
			 TVector3 posIn, 
...
void R3BSofTWIMPoint::Print(const Option_t* opt) const {
  cout << "-I- R3BSofTWIMPoint: STS Point for track " << fTrackID 
