...
#define EXT_STR_h101_WRSOFIA_ITEMS_INFO(ok, si, offset, struct_t, printerr)                                     \
    ...
    {                                                                                                           \
        ...
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA_ID, UINT32, "TIMESTAMP_SOFIA_ID", 65535);       \
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA_WR_T1, UINT32, "TIMESTAMP_SOFIA_WR_T1", 65535); \
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA_WR_T2, UINT32, "TIMESTAMP_SOFIA_WR_T2", 65535); \
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA_WR_T3, UINT32, "TIMESTAMP_SOFIA_WR_T3", 65535); \
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA_WR_T4, UINT32, "TIMESTAMP_SOFIA_WR_T4", 65535); \
                                                                                                                \
    } while (0);
