...
#define EXT_STR_h101_SOFTWIM_ITEMS_INFO(ok, si, offset, struct_t, printerr)                                       \
    ...
    {                                                                                                             \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTWIM_S1E, UINT32, "SOFTWIM_S1E", 160);       \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTWIM_S1T, UINT32, "SOFTWIM_S1T", 160);       \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTWIM_S1TREF, UINT32, "SOFTWIM_S1TREF", 10);  \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTWIM_S2E, UINT32, "SOFTWIM_S2E", 160);       \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTWIM_S2T, UINT32, "SOFTWIM_S2T", 160);       \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTWIM_S2TREF, UINT32, "SOFTWIM_S2TREF", 10);  \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTWIM_S3E, UINT32, "SOFTWIM_S3E", 160);       \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTWIM_S3T, UINT32, "SOFTWIM_S3T", 160);       \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTWIM_S3TREF, UINT32, "SOFTWIM_S3TREF", 10);  \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTWIM_S4E, UINT32, "SOFTWIM_S4E", 160);       \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTWIM_S4T, UINT32, "SOFTWIM_S4T", 160);       \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTWIM_S4TREF, UINT32, "SOFTWIM_S4TREF", 10);  \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
