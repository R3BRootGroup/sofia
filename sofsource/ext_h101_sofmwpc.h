...
#define EXT_STR_h101_SOFMWPC_ITEMS_INFO(ok,si,offset,struct_t,printerr) do { \
  ...
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFMWPC4Plane1Q,                 UINT32,\
                    "SOFMWPC4Plane1Q",320); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFMWPC4Plane1QI,                UINT32,\
                    "SOFMWPC4Plane1QI",                "SOFMWPC4Plane1Q"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFMWPC4Plane1Qv,                UINT32,\
                    "SOFMWPC4Plane1Qv",                "SOFMWPC4Plane1Q"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFMWPC4Plane2Q,                 UINT32,\
                    "SOFMWPC4Plane2Q",320); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFMWPC4Plane2QI,                UINT32,\
                    "SOFMWPC4Plane2QI",                "SOFMWPC4Plane2Q"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFMWPC4Plane2Qv,                UINT32,\
                    "SOFMWPC4Plane2Qv",                "SOFMWPC4Plane2Q"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFMWPC4Plane3Q,                 UINT32,\
                    "SOFMWPC4Plane3Q",320); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFMWPC4Plane3QI,                UINT32,\
                    "SOFMWPC4Plane3QI",                "SOFMWPC4Plane3Q"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFMWPC4Plane3Qv,                UINT32,\
                    "SOFMWPC4Plane3Qv",                "SOFMWPC4Plane3Q"); \
  \
} while (0);
