...
#define EXT_STR_h101_SOFTOFW_ITEMS_INFO(ok, si, offset, struct_t, printerr)                                       \
    ...
    {                                                                                                             \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P1TF, UINT32, "SOFTOFW_P1TF", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P1TC, UINT32, "SOFTOFW_P1TC", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P2TF, UINT32, "SOFTOFW_P2TF", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P2TC, UINT32, "SOFTOFW_P2TC", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P3TF, UINT32, "SOFTOFW_P3TF", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P3TC, UINT32, "SOFTOFW_P3TC", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P4TF, UINT32, "SOFTOFW_P4TF", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P4TC, UINT32, "SOFTOFW_P4TC", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P5TF, UINT32, "SOFTOFW_P5TF", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P5TC, UINT32, "SOFTOFW_P5TC", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P6TF, UINT32, "SOFTOFW_P6TF", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P6TC, UINT32, "SOFTOFW_P6TC", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P7TF, UINT32, "SOFTOFW_P7TF", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P7TC, UINT32, "SOFTOFW_P7TC", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P8TF, UINT32, "SOFTOFW_P8TF", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P8TC, UINT32, "SOFTOFW_P8TC", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P9TF, UINT32, "SOFTOFW_P9TF", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P9TC, UINT32, "SOFTOFW_P9TC", 10);      \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P10TF, UINT32, "SOFTOFW_P10TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P10TC, UINT32, "SOFTOFW_P10TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P11TF, UINT32, "SOFTOFW_P11TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P11TC, UINT32, "SOFTOFW_P11TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P12TF, UINT32, "SOFTOFW_P12TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P12TC, UINT32, "SOFTOFW_P12TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P13TF, UINT32, "SOFTOFW_P13TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P13TC, UINT32, "SOFTOFW_P13TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P14TF, UINT32, "SOFTOFW_P14TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P14TC, UINT32, "SOFTOFW_P14TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P15TF, UINT32, "SOFTOFW_P15TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P15TC, UINT32, "SOFTOFW_P15TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P16TF, UINT32, "SOFTOFW_P16TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P16TC, UINT32, "SOFTOFW_P16TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P17TF, UINT32, "SOFTOFW_P17TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P17TC, UINT32, "SOFTOFW_P17TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P18TF, UINT32, "SOFTOFW_P18TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P18TC, UINT32, "SOFTOFW_P18TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P19TF, UINT32, "SOFTOFW_P19TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P19TC, UINT32, "SOFTOFW_P19TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P20TF, UINT32, "SOFTOFW_P20TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P20TC, UINT32, "SOFTOFW_P20TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P21TF, UINT32, "SOFTOFW_P21TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P21TC, UINT32, "SOFTOFW_P21TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P22TF, UINT32, "SOFTOFW_P22TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P22TC, UINT32, "SOFTOFW_P22TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P23TF, UINT32, "SOFTOFW_P23TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P23TC, UINT32, "SOFTOFW_P23TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P24TF, UINT32, "SOFTOFW_P24TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P24TC, UINT32, "SOFTOFW_P24TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P25TF, UINT32, "SOFTOFW_P25TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P25TC, UINT32, "SOFTOFW_P25TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P26TF, UINT32, "SOFTOFW_P26TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P26TC, UINT32, "SOFTOFW_P26TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P27TF, UINT32, "SOFTOFW_P27TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P27TC, UINT32, "SOFTOFW_P27TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P28TF, UINT32, "SOFTOFW_P28TF", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTOFW_P28TC, UINT32, "SOFTOFW_P28TC", 10);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                    \
