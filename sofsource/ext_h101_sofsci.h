...
#define EXT_STR_h101_SOFSCI_ITEMS_INFO(ok, si, offset, struct_t, printerr)                                           \
    ...
    {                                                                                                                \
        ok = 1;                                                                                                      \
        /* RAW */                                                                                                    \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFSCI1TFM, UINT32, "SOFSCI1TFM", 2);              \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFSCI1TF, UINT32, "SOFSCI1TF", 80);               \
        EXT_STR_ITEM_INFO_ZZP(ok, si, offset, struct_t, printerr, SOFSCI1TFv, UINT32, "SOFSCI1TFv", "SOFSCI1TF");    \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFSCI1TCM, UINT32, "SOFSCI1TCM", 2);              \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFSCI1TC, UINT32, "SOFSCI1TC", 80);               \
        EXT_STR_ITEM_INFO_ZZP(ok, si, offset, struct_t, printerr, SOFSCI1TCv, UINT32, "SOFSCI1TCv", "SOFSCI1TC");    \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFSCI2TFM, UINT32, "SOFSCI2TFM", 2);              \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFSCI2TF, UINT32, "SOFSCI2TF", 80);               \
        EXT_STR_ITEM_INFO_ZZP(ok, si, offset, struct_t, printerr, SOFSCI2TFv, UINT32, "SOFSCI2TFv", "SOFSCI2TF");    \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFSCI2TCM, UINT32, "SOFSCI2TCM", 2);              \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFSCI2TC, UINT32, "SOFSCI2TC", 80);               \
