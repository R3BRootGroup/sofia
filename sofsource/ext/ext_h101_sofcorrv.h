...
#define EXT_STR_h101_SOFCORRV_ITEMS_INFO(ok, si, offset, struct_t, printerr)                                  \
    do                                                                                                        \
    {                                                                                                         \
        ok = 1;                                                                                               \
        /* RAW */                                                                                             \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFCORRV_TRCM, UINT32, "SOFCORRV_TRCM", 1); \
        EXT_STR_ITEM_INFO_ZZP(                                                                                \
            ok, si, offset, struct_t, printerr, SOFCORRV_TRCMI, UINT32, "SOFCORRV_TRCMI", "SOFCORRV_TRCM");   \
        EXT_STR_ITEM_INFO_ZZP(                                                                                \
            ok, si, offset, struct_t, printerr, SOFCORRV_TRCME, UINT32, "SOFCORRV_TRCME", "SOFCORRV_TRCM");   \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFCORRV_TRC, UINT32, "SOFCORRV_TRC", 100); \
        EXT_STR_ITEM_INFO_ZZP(                                                                                \
            ok, si, offset, struct_t, printerr, SOFCORRV_TRCv, UINT32, "SOFCORRV_TRCv", "SOFCORRV_TRC");      \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFCORRV_TRFM, UINT32, "SOFCORRV_TRFM", 1); \
        EXT_STR_ITEM_INFO_ZZP(                                                                                \
            ok, si, offset, struct_t, printerr, SOFCORRV_TRFMI, UINT32, "SOFCORRV_TRFMI", "SOFCORRV_TRFM");   \
        EXT_STR_ITEM_INFO_ZZP(                                                                                \
            ok, si, offset, struct_t, printerr, SOFCORRV_TRFME, UINT32, "SOFCORRV_TRFME", "SOFCORRV_TRFM");   \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFCORRV_TRF, UINT32, "SOFCORRV_TRF", 100); \
        EXT_STR_ITEM_INFO_ZZP(                                                                                \
            ok, si, offset, struct_t, printerr, SOFCORRV_TRFv, UINT32, "SOFCORRV_TRFv", "SOFCORRV_TRF");      \
                                                                                                              \
    } while (0);
