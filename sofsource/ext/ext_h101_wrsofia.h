...
#define EXT_STR_h101_WRSOFIA_ITEMS_INFO(ok, si, offset, struct_t, printerr)                                     \
    do                                                                                                          \
    {                                                                                                           \
        ok = 1;                                                                                                 \
        /* RAW */                                                                                               \
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA1ID, UINT32, "TIMESTAMP_SOFIA1ID", 65535);       \
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA1WR_T1, UINT32, "TIMESTAMP_SOFIA1WR_T1", 65535); \
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA1WR_T2, UINT32, "TIMESTAMP_SOFIA1WR_T2", 65535); \
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA1WR_T3, UINT32, "TIMESTAMP_SOFIA1WR_T3", 65535); \
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA1WR_T4, UINT32, "TIMESTAMP_SOFIA1WR_T4", 65535); \
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA2ID, UINT32, "TIMESTAMP_SOFIA2ID", 65535);       \
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA2WR_T1, UINT32, "TIMESTAMP_SOFIA2WR_T1", 65535); \
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA2WR_T2, UINT32, "TIMESTAMP_SOFIA2WR_T2", 65535); \
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA2WR_T3, UINT32, "TIMESTAMP_SOFIA2WR_T3", 65535); \
        EXT_STR_ITEM_INFO_LIM(                                                                                  \
            ok, si, offset, struct_t, printerr, TIMESTAMP_SOFIA2WR_T4, UINT32, "TIMESTAMP_SOFIA2WR_T4", 65535); \
                                                                                                                \
    } while (0);
