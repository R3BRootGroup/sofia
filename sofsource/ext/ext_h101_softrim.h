...
#define EXT_STR_h101_SOFTRIM_ITEMS_INFO(ok, si, offset, struct_t, printerr)                                          \
    ...
    {                                                                                                                \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S1E, UINT32, "SOFTRIM_S1E", 600);          \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S1T, UINT32, "SOFTRIM_S1T", 600);          \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S1TREF, UINT32, "SOFTRIM_S1TREF", 100);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
            ok, si, offset, struct_t, printerr, SOFTRIM_S1TREFv, UINT32, "SOFTRIM_S1TREFv", "SOFTRIM_S1TREF");       \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S1TTRIGM, UINT32, "SOFTRIM_S1TTRIGM", 1);  \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
            ok, si, offset, struct_t, printerr, SOFTRIM_S1TTRIGMI, UINT32, "SOFTRIM_S1TTRIGMI", "SOFTRIM_S1TTRIGM"); \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
            ok, si, offset, struct_t, printerr, SOFTRIM_S1TTRIGME, UINT32, "SOFTRIM_S1TTRIGME", "SOFTRIM_S1TTRIGM"); \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S1TTRIG, UINT32, "SOFTRIM_S1TTRIG", 100);  \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
            ok, si, offset, struct_t, printerr, SOFTRIM_S1TTRIGv, UINT32, "SOFTRIM_S1TTRIGv", "SOFTRIM_S1TTRIG");    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S2E, UINT32, "SOFTRIM_S2E", 600);          \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S2T, UINT32, "SOFTRIM_S2T", 600);          \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S2TREF, UINT32, "SOFTRIM_S2TREF", 100);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
            ok, si, offset, struct_t, printerr, SOFTRIM_S2TREFv, UINT32, "SOFTRIM_S2TREFv", "SOFTRIM_S2TREF");       \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S2TTRIGM, UINT32, "SOFTRIM_S2TTRIGM", 1);  \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
            ok, si, offset, struct_t, printerr, SOFTRIM_S2TTRIGMI, UINT32, "SOFTRIM_S2TTRIGMI", "SOFTRIM_S2TTRIGM"); \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
            ok, si, offset, struct_t, printerr, SOFTRIM_S2TTRIGME, UINT32, "SOFTRIM_S2TTRIGME", "SOFTRIM_S2TTRIGM"); \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S2TTRIG, UINT32, "SOFTRIM_S2TTRIG", 100);  \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
            ok, si, offset, struct_t, printerr, SOFTRIM_S2TTRIGv, UINT32, "SOFTRIM_S2TTRIGv", "SOFTRIM_S2TTRIG");    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S3E, UINT32, "SOFTRIM_S3E", 600);          \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S3T, UINT32, "SOFTRIM_S3T", 600);          \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S3TREF, UINT32, "SOFTRIM_S3TREF", 100);    \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
            ok, si, offset, struct_t, printerr, SOFTRIM_S3TREFv, UINT32, "SOFTRIM_S3TREFv", "SOFTRIM_S3TREF");       \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S3TTRIGM, UINT32, "SOFTRIM_S3TTRIGM", 1);  \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
            ok, si, offset, struct_t, printerr, SOFTRIM_S3TTRIGMI, UINT32, "SOFTRIM_S3TTRIGMI", "SOFTRIM_S3TTRIGM"); \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
            ok, si, offset, struct_t, printerr, SOFTRIM_S3TTRIGME, UINT32, "SOFTRIM_S3TTRIGME", "SOFTRIM_S3TTRIGM"); \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFTRIM_S3TTRIG, UINT32, "SOFTRIM_S3TTRIG", 100);  \
        EXT_STR_ITEM_INFO_ZZP(                                                                                       \
            ok, si, offset, struct_t, printerr, SOFTRIM_S3TTRIGv, UINT32, "SOFTRIM_S3TTRIGv", "SOFTRIM_S3TTRIG");    \
                                                                                                                     \
    } while (0);
