...
#define EXT_STR_h101_SOFTWIM_ITEMS_INFO(ok,si,offset,struct_t,printerr) do { \
  ...
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S1TTRIGM,                UINT32,\
                    "SOFTWIM_S1TTRIGM",1); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S1TTRIGMI,               UINT32,\
                    "SOFTWIM_S1TTRIGMI",               "SOFTWIM_S1TTRIGM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S1TTRIGME,               UINT32,\
                    "SOFTWIM_S1TTRIGME",               "SOFTWIM_S1TTRIGM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S1TTRIG,                 UINT32,\
                    "SOFTWIM_S1TTRIG",100); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S1TTRIGv,                UINT32,\
                    "SOFTWIM_S1TTRIGv",                "SOFTWIM_S1TTRIG"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S2EM,                    UINT32,\
                    "SOFTWIM_S2EM",16); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
  ...
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S2TTRIGM,                UINT32,\
                    "SOFTWIM_S2TTRIGM",1); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S2TTRIGMI,               UINT32,\
                    "SOFTWIM_S2TTRIGMI",               "SOFTWIM_S2TTRIGM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S2TTRIGME,               UINT32,\
                    "SOFTWIM_S2TTRIGME",               "SOFTWIM_S2TTRIGM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S2TTRIG,                 UINT32,\
                    "SOFTWIM_S2TTRIG",100); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S2TTRIGv,                UINT32,\
                    "SOFTWIM_S2TTRIGv",                "SOFTWIM_S2TTRIG"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S3EM,                    UINT32,\
                    "SOFTWIM_S3EM",16); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
  ...
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S3TTRIGM,                UINT32,\
                    "SOFTWIM_S3TTRIGM",1); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S3TTRIGMI,               UINT32,\
                    "SOFTWIM_S3TTRIGMI",               "SOFTWIM_S3TTRIGM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S3TTRIGME,               UINT32,\
                    "SOFTWIM_S3TTRIGME",               "SOFTWIM_S3TTRIGM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S3TTRIG,                 UINT32,\
                    "SOFTWIM_S3TTRIG",100); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S3TTRIGv,                UINT32,\
                    "SOFTWIM_S3TTRIGv",                "SOFTWIM_S3TTRIG"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S4EM,                    UINT32,\
                    "SOFTWIM_S4EM",16); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
  ...
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S4TTRIGM,                UINT32,\
                    "SOFTWIM_S4TTRIGM",1); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S4TTRIGMI,               UINT32,\
                    "SOFTWIM_S4TTRIGMI",               "SOFTWIM_S4TTRIGM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S4TTRIGME,               UINT32,\
                    "SOFTWIM_S4TTRIGME",               "SOFTWIM_S4TTRIGM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S4TTRIG,                 UINT32,\
                    "SOFTWIM_S4TTRIG",100); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFTWIM_S4TTRIGv,                UINT32,\
                    "SOFTWIM_S4TTRIGv",                "SOFTWIM_S4TTRIG"); \
  \
} while (0);
