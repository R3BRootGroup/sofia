...
#define EXT_STR_h101_SOFCORRM_ITEMS_INFO(ok, si, offset, struct_t, printerr)                                \
    do                                                                                                      \
    {                                                                                                       \
        ok = 1;                                                                                             \
        /* RAW */                                                                                           \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFCORRM_TRM, UINT32, "SOFCORRM_TRM", 1); \
        EXT_STR_ITEM_INFO_ZZP(                                                                              \
            ok, si, offset, struct_t, printerr, SOFCORRM_TRMI, UINT32, "SOFCORRM_TRMI", "SOFCORRM_TRM");    \
        EXT_STR_ITEM_INFO_ZZP(                                                                              \
            ok, si, offset, struct_t, printerr, SOFCORRM_TRME, UINT32, "SOFCORRM_TRME", "SOFCORRM_TRM");    \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFCORRM_TR, UINT32, "SOFCORRM_TR", 100); \
        EXT_STR_ITEM_INFO_ZZP(                                                                              \
            ok, si, offset, struct_t, printerr, SOFCORRM_TRv, UINT32, "SOFCORRM_TRv", "SOFCORRM_TR");       \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFCORRM_TTM, UINT32, "SOFCORRM_TTM", 1); \
        EXT_STR_ITEM_INFO_ZZP(                                                                              \
            ok, si, offset, struct_t, printerr, SOFCORRM_TTMI, UINT32, "SOFCORRM_TTMI", "SOFCORRM_TTM");    \
        EXT_STR_ITEM_INFO_ZZP(                                                                              \
            ok, si, offset, struct_t, printerr, SOFCORRM_TTME, UINT32, "SOFCORRM_TTME", "SOFCORRM_TTM");    \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, SOFCORRM_TT, UINT32, "SOFCORRM_TT", 100); \
        EXT_STR_ITEM_INFO_ZZP(                                                                              \
            ok, si, offset, struct_t, printerr, SOFCORRM_TTv, UINT32, "SOFCORRM_TTv", "SOFCORRM_TT");       \
                                                                                                            \
    } while (0);
