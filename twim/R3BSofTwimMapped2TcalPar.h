#ifndef __R3BSOFTWIMMAPPED2TCALPAR_H__
#define __R3BSOFTWIMMAPPED2TCALPAR_H__
...
class R3BSofTwimMapped2TcalPar : public FairTask {
  
 public:
  
  /** Default constructor **/
  R3BSofTwimMapped2TcalPar();
  
  /** Standard constructor **/
  R3BSofTwimMapped2TcalPar(const char* name, Int_t iVerbose=1);
  
  /** Destructor **/
  virtual ~R3BSofTwimMapped2TcalPar();
 ...
 protected:
  ...
  // input data
  TClonesArray* fMappedTwim;         // Array with mapped data from scintillator detectors - input data.
 ...
 public:
  ClassDef(R3BSofTwimMapped2TcalPar,0);
};

#endif //__R3BSOFTWIMMAPPED2TCALPAR_H__
